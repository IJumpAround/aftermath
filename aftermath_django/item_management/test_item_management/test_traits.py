...
class TraitModelTests(TestCase):
    ...
    def setUp(self):
        ...
        self.weapon_template = WeaponTraitTemplate.objects.create(trait_name="Some Trait (X)", scaling_trait=True,
                                                                  tier=self.tier, trait_type='Weapon')
        self.armor_template = ArmorTraitTemplate.objects.create(trait_name="Impeding (X)", scaling_trait=True,
                                                                tier=self.tier, trait_type='Armor')
    ...
    def test_create_from_template(self):
        x_val = 3
        armor_piercing_template = WeaponTraitTemplate.objects.create(trait_name="Armor Piercing (X)", tier=self.tier,
                                                                     scaling_trait=True, trait_type='Weapon')

        armor_piercing_instance = WeaponTrait.create_trait_from_template(armor_piercing_template, self.weapon,
                                                                         weapon_type='Melee', x_value=x_val)
    ...
    def test_str_method_on_scalable(self):
        x_val = 4
        trait = WeaponTrait.create_trait_from_template(self.weapon_template, self.weapon, weapon_type='Melee',
                                                       x_value=x_val)
    ...
    def test_str_method_on_non_scalable(self):
        template = WeaponTraitTemplate.objects.create(trait_name="A non scaling trait", scaling_trait=False,
                                                      tier=self.tier, trait_type='Weapon')
    ...
    def test_item_can_have_multiple_traits(self):
        weapon_template2 = WeaponTraitTemplate.objects.create(trait_name="Another Weapon Trait", scaling_trait=False,
                                                              tier=self.tier, trait_type='Weapon')
